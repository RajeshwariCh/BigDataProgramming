...
object ICP6 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //Saving to File
    stationGraph.vertices.write.csv("C:\\Users\\Rajeshwari\\IdeaProjects\\untitled\\vertices")

    stationGraph.edges.write.csv("C:\\Users\\Rajeshwari\\IdeaProjects\\untitled\\edge")
