...
object ICP5 {
  def main(args: Array[String]) {
    ...
    val trips_df = spark.read
      ...
      .load("C:\\Users\\Rajeshwari\\IdeaProjects\\untitled\\201508_trip_data.csv")

    val station_df = spark.read
      .format("csv")
      .option("header", "true") //reading the headers
      .option("mode", "DROPMALFORMED")
      .load("C:\\Users\\Rajeshwari\\IdeaProjects\\untitled\\201508_station_data.csv")
    ...
    stationGraph.vertices.write.csv("C:\\Users\\Rajeshwari\\IdeaProjects\\untitled\\Graphs1")

    stationGraph.edges.write.csv("C:\\Users\\Rajeshwari\\IdeaProjects\\untitled\\Graphs1\\graph2")
